...
//		scan.close();
	...
	private static void subMeniuPlay() {
		...
		do {
			...
			if (!subMeniuOptions.equalsIgnoreCase("1") && !subMeniuOptions.equalsIgnoreCase("2")
					&& !subMeniuOptions.equalsIgnoreCase("finish")) {
				System.out.println("Wrong keyword, try again...");
				System.out.print("\nType here: ");
			}
		} while (!subMeniuOptions.equalsIgnoreCase("1") && !subMeniuOptions.equalsIgnoreCase("2")
				&& !subMeniuOptions.equalsIgnoreCase("finish"));
...
//		scan.close();
	...
	private static void discarding1Card() {
		...
		do {
			...
			if (cardNumber.equalsIgnoreCase("1") || cardNumber.equalsIgnoreCase("2") || cardNumber.equalsIgnoreCase("3")
					|| cardNumber.equalsIgnoreCase("4") || cardNumber.equalsIgnoreCase("5")) {
				// empty
			} else {
				System.out.println("Wrong number, try again...");
			}
		} while (!cardNumber.equalsIgnoreCase("1") && !cardNumber.equalsIgnoreCase("2")
				&& !cardNumber.equalsIgnoreCase("3") && !cardNumber.equalsIgnoreCase("4")
